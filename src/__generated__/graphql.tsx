...
export type FilmsQuery = { __typename?: 'Root', allFilms?: { __typename?: 'FilmsConnection', totalCount?: number | null, films?: Array<{ __typename?: 'Film', director?: string | null, title?: string | null, episodeID?: number | null, releaseDate?: string | null } | null> | null } | null };

export type PlanetsQueryVariables = Exact<{ [key: string]: never; }>;


export type PlanetsQuery = { __typename?: 'Root', allPlanets?: { __typename?: 'PlanetsConnection', planets?: Array<{ __typename?: 'Planet', id: string, name?: string | null, population?: number | null } | null> | null } | null };
...
export const PlanetsDocument = gql`
    query Planets {
  allPlanets {
    planets {
      id
 ...
 * __usePlanetsQuery__
 *
 * To run a query within a React component, call `usePlanetsQuery` and pass it any options that fit your needs.
 * When your component renders, `usePlanetsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = usePlanetsQuery({
 *   variables: {
 *   },
 * });
 */
export function usePlanetsQuery(baseOptions?: Apollo.QueryHookOptions<PlanetsQuery, PlanetsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<PlanetsQuery, PlanetsQueryVariables>(PlanetsDocument, options);
      }
export function usePlanetsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<PlanetsQuery, PlanetsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<PlanetsQuery, PlanetsQueryVariables>(PlanetsDocument, options);
        }
export type PlanetsQueryHookResult = ReturnType<typeof usePlanetsQuery>;
export type PlanetsLazyQueryHookResult = ReturnType<typeof usePlanetsLazyQuery>;
export type PlanetsQueryResult = Apollo.QueryResult<PlanetsQuery, PlanetsQueryVariables>;